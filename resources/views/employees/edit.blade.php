                    ...
                    <form action="{{ route('employees.update', $employee) }}" method="POST">
                        ...
                        @method('PUT') <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="cpf" id="cpf" class="block mt-1 w-full rounded-md shadow-sm border-gray-300" value="{{ old('cpf', $employee->cpf) }}" required>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <input type="tel" name="phone" id="phone" class="block mt-1 w-full rounded-md shadow-sm border-gray-300" value="{{ old('phone', $employee->phone) }}" required>
                            </div>
